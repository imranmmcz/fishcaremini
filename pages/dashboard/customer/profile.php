<?php
/**
 * Fish Care System - Customer Profile Page
 */
...
try {
    ...
    // Get current district and upazila if exists
    $districts = [];
    $upazilas = [];
...
<div class="content-wrapper">
        ...
        <form method="POST" onsubmit="return validateForm()">
            ...
            <div class="row" style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
                <div class="form-group">
                    ...
                    <input type="text" name="name_bn" id="name_bn" class="form-control" required value="<?php echo htmlspecialchars($user['name_bn'] ?? ''); ?>">
                </div>
    ...
    <div class="card" style="margin-top: 24px;">
        ...
        <form method="POST" action="<?php echo SITE_URL; ?>/pages/auth/change-password.php">
            <div class="row" style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
                <div class="form-group">
                    <label class="form-label">পুরানো পাসওয়ার্ড</label>
